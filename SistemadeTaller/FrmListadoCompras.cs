...
namespace SistemadeTaller
{
    public partial class FrmListadoCompras : Form
    {
        ...
        private void btnBuscarOrden_Click(object sender, EventArgs e)
        {
            ...
            Grilla.Columns[1].HeaderText = "Proveedor";
            Grilla.Columns[2].HeaderText = "Teléfono";
            Grilla.Columns[3].HeaderText = "Factura";
            Grilla.Columns[5].HeaderText = "Cantidad";
          //  Grilla.Columns[1].Width = 200;
          //  Grilla.Columns[4].Width = 180;
            string Col = "12;18;20;10;10;10;10;10";
