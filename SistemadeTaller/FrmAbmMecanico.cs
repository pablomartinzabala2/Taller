...
{
    public partial class FrmAbmMecanico : Form
    {
        public FrmAbmMecanico()
        {
            InitializeComponent();
        }
        ...
        private void FrmAbmMecanico_Load(object sender, EventArgs e)
        {
            Botonera(1);
            Grupo.Enabled = false;
        }
        ...
        private void btnAbrir_Click(object sender, EventArgs e)
        {
            ...
            //nombre de la tabla, 
            Principal.TablaPrincipal = "Mecanico";

            Principal.OpcionesColumnasGrilla = "CodMecanico; Nombre;Apellido";
